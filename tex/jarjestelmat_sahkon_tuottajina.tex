...
\section{Järjestelmien tuotto-ominaisuudet}
  ...
  Tuottajasta puhuttaessa on taas useampi syy energiavarastojen hyödyntämiseen. Matala sähköstä saatava markkinahinta on tuottajallakin syy hyödyntää energiavarastoa, varsinkin jos hinta on tuotantohuipun aikaan matala. Tulevaisuudessa myös verkkokoodi voi pakottaa tuotantolaitokset investoimaan energiavarastoon sähköverkon vakauden ja jännitteen laadun ylläpitämiseksi.  
